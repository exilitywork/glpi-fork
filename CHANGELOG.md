...
## [9.4.5.205]
- Плагин dashboard: реализована поддержка дополнительных полей в отчетах и диграммах по группе и специалисту
- Плагин dashboard: оптимизирован алгоритм работы плагина

## [9.4.5.204]
- Плагин fields: реализована поддержка шаблонов заявок для дополнительных полей - Капешко

## [9.4.5.2033]
- Список заявок: добавлены все роли для Моих групп в кнопках фильтров Выполненные и Открытые
- Список заявок: Исключено дублирование кнопок фильтров

## [9.4.5.2031]
- Исправлены ошибка обработки событий при вводе текста в редакторе tinyMCE + изменен тип событий на oninput для полей заголовка и описания заявки

## [9.4.5.203] 2020-09-15
- Планирование: добавлена видимость заметок членов своих групп
- Планирование: изменен цвет фона для просроченных и выполненных событий

## [9.4.5.202] 2020-09-11
- Согласования заявок: добавлено поле ввода комментария и изменено расположение кнопок в разделах Работа с заявкой и Согласования

## [9.4.5.201] 2020-09-10
-Теперь в разделе Планирование вкладка по умолчанию - Месяц
