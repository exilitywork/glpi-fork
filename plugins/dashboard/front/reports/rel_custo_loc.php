...
<html>
<head>
<title> GLPI - <?php echo __('Cost') .'  '. __('by Location','dashboard') ?> </title>
...
<a href="../index.php"><i class="fa fa-home" style="font-size:14pt; margin-left:25px;"></i><span></span></a>
    ...
    <div id="titulo_rel" > <?php echo __('Cost') .'  '. __('by Location','dashboard') ?> </div>
        <div id="datas-tec" class="span12 fluid" >
		    <form id="form1" name="form1" class="form_rel" method="post" action="rel_custo_loc.php?con=1">
...
if($con == "1") {
	...
	if($id_loc == 0) {
		...
		echo '<script language="javascript"> location.href="rel_custo_loc.php"; </script>';
	}
	...
	<table class='fluid'  style='font-size: 18px; font-weight:bold; width:100%;' cellpadding = '1px'>
		<tr style='width: 450px;'>
			<td style='vertical-align:middle;'> <span style='color: #000;'>".__('Location').": </span>". $row['name'] . "</td>
		</tr>
		<tr>	
        ...
        buttons: [
             ...
             },
             {
                 ...
                 text: "<?php echo __('Print','dashboard'); ?>",
		                 ...
		                 message: "<div id='print' class='fluid span12' style='margin-bottom: 25px; margin-left: -1px;'><table id='print_tb' class='fluid'  style='width: 80%; margin-left: 10%; font-size: 18px; font-weight:bold;' cellpadding = '1px'><tr><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo __('Entity', 'dashboard'); ?> : </span><?php echo $ent_name; ?> </td> <td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Tickets','dashboard'); ?> : </span><?php echo $conta_cons ; ?></td><td colspan='2' style='font-size: 16px; font-weight:bold; vertical-align:middle; width:200px;'><span style='color:#000;'> <?php echo  __('Period','dashboard'); ?> : </span> <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> </td></tr> <tr><td>&nbsp;</td></tr> <tr><td style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> <?php echo  __('Total cost'); ?> : </span><?php echo number_format($total_cost, 2, ',', ' '); ?></td></tr> </table></div>",		     
		                }, 
							  {               
		                 extend: "print",
		                 autoPrint: true,
                 ...
                 buttons: [ "csvHtml5", "excelHtml5",
                  {
                 		...
                 		message: "<?php echo __('Location'); ?> : <?php echo $ent_name. ' - '; ?> <?php echo  __('Tickets','dashboard'); ?> : <?php echo $conta_cons . '  - ' ; ?>  <?php echo  __('Total cost'); ?> : <?php echo number_format($total_cost, 2, ',', ' ') .' - '; ?> <?php echo  __('Period','dashboard'); ?> : <?php echo conv_data($data_ini2); ?> - <?php echo conv_data($data_fin2); ?>"							
                  } 
                  ]
             }
        ]
