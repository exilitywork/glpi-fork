...
<html>
<head>
<title> GLPI - <?php echo __('Cost') .'  '. __('by Entity','dashboard') ?> </title>
...
<a href="../index.php"><i class="fa fa-home" style="font-size:14pt; margin-left:25px;"></i><span></span></a>
    ...
    <div id="titulo_rel" > <?php echo __('Cost') .'  '. __('by Entity','dashboard') ?> </div>
        <div id="datas-tec" class="span12 fluid" >
		    <form id="form1" name="form1" class="form_rel" method="post" action="rel_custo_ent.php?con=1">
...
if($con == "1") {
	...
	AND glpi_ticketcosts.entities_id = ". $id_ent ."
                 ...
                 buttons: [ "csvHtml5", "excelHtml5",
                  {
                 		...
                 		message: "<?php echo __('Entity', 'dashboard'); ?> : <?php echo $ent_name. ' - '; ?> <?php echo  __('Tickets','dashboard'); ?> : <?php echo $conta_cons . '  - ' ; ?>  <?php echo  __('Total cost'); ?> : <?php echo number_format($total_cost, 2, ',', ' ') .' - '; ?> <?php echo  __('Period','dashboard'); ?> : <?php echo conv_data($data_ini2); ?> - <?php echo conv_data($data_fin2); ?>"							
                  } 
                  ]
             }
        ]
