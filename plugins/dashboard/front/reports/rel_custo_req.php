...
<html>
<head>
<title> GLPI - <?php echo __('Cost') .'  '. __('by Requester','dashboard') ?> </title>
...
if($con == "1") {
	...
	if($id_tec == 0) {
		...
		echo '<script language="javascript"> location.href="rel_custo_req.php"; </script>';
	}
	...
	<table class='fluid'  style='font-size: 18px; font-weight:bold; width:100%;' cellpadding = 1px border='0'>
		<tr style='width: 450px;'>
			...
			<td style='vertical-align:middle;' class='left' colspan=2> <span style='color: #000;'>".__('Tickets','dashboard').": </span>". $conta_cons ."</td>
