	...
	<div id='container-fluid' style="margin: 0px 5% 0px 5%;"> 
		<div id="charts" class="fluid chart"> 
			<div id="head" class="fluid">
				...
				<div id="titulo_graf"> <?php echo __('Tickets','dashboard') .'  '. __('by SLA','dashboard'); ?>  - <?php echo __('Time to own'); ?>  
							...
							<table border="0" cellspacing="0" cellpadding="0">
								...
								<tr align="center">
									<td>
										...
										<button class="btn btn-primary btn-sm" type="button" name="Limpar" value="Limpar" onclick="location.href='sltsa.php'" ><i class="fa fa-trash-o"></i>&nbsp; <?php echo __('Clean','dashboard'); ?> </button>
									</td>
								</tr>
							</table>
						<p>
			...
			<div id="graf1" class="row-fluid">
				<?php include ("./inc/grafbar_sltsa_mes.inc.php"); ?>
			</div>
		</div>
	</div>
</div>
