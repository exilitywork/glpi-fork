...
<html> 
<head>
<title>GLPI - <?php echo __('Tickets','dashboard') .'  '. __('by SLA','dashboard').'s'  ?></title>
	...
	<div id='container-fluid' style="margin: 0px 5% 0px 5%;"> 
		<div id="charts" class="fluid chart"> 
			<div id="head" class="fluid">
				...
				<div id="titulo_graf"> <?php echo __('Tickets','dashboard') .'  '. __('by SLA','dashboard'); ?>  - <?php echo __('Time to resolve'); ?>  
			...
			<div id="graf1" class="row-fluid">
				<?php include ("./inc/grafbar_sltsr_mes.inc.php"); ?>
			</div>
		</div>
	</div>
</div>
