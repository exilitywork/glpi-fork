...
<html> 
<head>
<title>GLPI - <?php echo __('Tickets across time','dashboard');  ?></title>
...
<div id='container-fluid' style="margin: 0px 5% 0px 5%;">  
	<div id="charts" class="fluid chart"> 
				...
				<td style="margin-top:2px;">
					...
					<tr align="center">
						<td>
							...
							<button class="btn btn-primary btn-sm" type="button" name="Limpar" value="Limpar" onclick="location.href='times.php'" ><i class="fa fa-trash-o"></i>&nbsp; <?php echo __('Clean','dashboard'); ?> </button>
						</td>
					</tr>
				</table>
				<p>
		...
		<div id="graf_hour" class="col-md-12">
			<?php include ("./inc/grafbar_ticket_hour.inc.php"); ?>	
		</div>
		
		<div id="grafday" class="col-md-12" style="margin-top: 30px;">
			<?php include ("./inc/grafbar_ticket_day.inc.php"); ?>	
		</div>
		
		<div id="grafmonth" class="col-md-12" style="margin-top: 35px;">
			<?php include ("./inc/grafbar_ticket_month.inc.php"); ?>	
		</div>
