...
class PluginFusioninventoryFormatconvert {
   ...
   static function computerInventoryTransformation($array) {
	...
	$array_tmp['operatingsystems_id'] = $array['OPERATINGSYSTEM']['FULL_NAME'];  //  FIX OS NAME for BELWEST GLPI (full name OS output)
	unset($array_tmp['operatingsystemeditions_id']);  //FIX EDITING EDITION OS for BELWEST GLPI
